...
import com.restaurante.restaurantebackend.patrones.factory.FabricaMesa;
import com.restaurante.restaurantebackend.patrones.factory.FabricaDelivery;
...
public class RestauranteFacade {
    ...
    public Pedido crearPedido(String tipo, int id, String cliente, String datoExtra) {
        ...
        if (nuevoPedido instanceof com.restaurante.restaurantebackend.patrones.factory.PedidoMesa) {
